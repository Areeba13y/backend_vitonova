...
@section('page_title', 'Create Collaboration')
...
<div class="mb-4 sm:mb-6 bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex items-start gap-3">
            ...
            <div>
                <h2 class="text-xl font-semibold text-gray-800">Add New Collaboration</h2>
                <p class="text-sm text-gray-500 mt-1">Create a new partnership</p>
            </div>
        </div>
    ...
    <div class="p-4 sm:p-6">
        <form id="collaborationForm" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <div id="logoPreviewContainer" class="hidden w-full lg:w-64">
...
$(document).ready(function() {
    ...
    $('#collaborationForm').submit(function(e) {
        ...
        $.ajax({
            url: '{{ route("collaborations.store") }}',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            error: function(xhr) {
                if (xhr.status === 422) {
                    ...
                    Toast.fire({
                        icon: 'error',
                        title: xhr.responseJSON.message || 'Error creating collaboration'
                    });
                }
            },
            complete: function() {
